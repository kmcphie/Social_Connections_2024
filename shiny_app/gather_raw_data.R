...
responses_clean <- responses_1 %>%
  rename(gap_year = "1. Have you taken a gap year?",
         ...
         p1_meet = "Where/how did you first meet this person?...11",
         p1_closeness = "How close do you feel to this person on a scale of 1 to 5?...12",
         p2_name = "Name of the second person (first and last)",
         p2_meet = "Where/how did you first meet this person?...14",
         p2_closeness = "How close do you feel to this person on a scale of 1 to 5?...15",
         p3_name = "Name of the third person (first and last)",
         p3_meet = "Where/how did you first meet this person?...17",
         p3_closeness = "How close do you feel to this person on a scale of 1 to 5?...18",
         p4_name = "Name of the fourth person (first and last)",
         p4_meet = "Where/how did you first meet this person?...20",
         p4_closeness = "How close do you feel to this person on a scale of 1 to 5?...21",
