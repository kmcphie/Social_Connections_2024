...
top_best_freq %>%
  ...
  theme_bw() +
  labs(title = "Expectations" , subtitle = "How Respondents Speculated on the Best Mediums for Connecting with Peers (Top 5)", y = "Count",
       x = "Expected Medium") +
  scale_y_continuous(labels = scales::percent) +
...
top_pmeet_freq %>%
  ...
  geom_col(fill = "#6fb4d2") +
  theme_bw() +
  labs(title = "Reality" , subtitle = "How Respondents Reported Actually Meeting Their Closest 4 Friends (Top 5 Mediums)",
       x = "Reality Medium",
       y = "Count") +
    scale_y_continuous(labels = scales::percent) +
  theme(axis.text.x = element_text(size = 8))
