...
fit_gs %>%
  ...
  theme_bw() +
  labs(x = "Satisfaction", y = "Probabiliy", title = 
         "Posterior Probability Distribution", subtitle = 
         "Average Satisfaction for On vs. Off Campus Students")


  # Posterior Probability Distribution of Satisfaction, Yard vs. Quad
...
yvq_model <- stan_glm(data = model_data3,
                 formula = satisfaction ~ location,
                 refresh = 0)

yvq_model_clean <- yvq_model %>%
  as_tibble() %>%
