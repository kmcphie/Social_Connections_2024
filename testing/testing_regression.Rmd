...
# Recitation: How do I graph a posterior with multiple covariates? Check
# interpretation? Clarify purpose of workflow?
...
two <- stan_glm(formula = satisfaction ~ on_campus + 1,
                data = model_data,
                refresh = 0,
                family = gaussian())
