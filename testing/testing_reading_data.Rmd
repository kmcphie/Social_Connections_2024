...
```{r}
responses <- read_rds("./testing/responses_final.rds")
```
...
```{r}
# Getting ids for the p1-p4, most_connected, and name columns 
...
# This successfully assign a matching id for the p1-p4, most_connected, and name
# columns!!!
...
# Entire dataset with correct ids
id4_responses <- responses_clean %>%
  pivot_longer(cols = c(p1_name, p2_name, 
                        p3_name, p4_name, 
                        name, most_connected),
               names_to = "degree",
               values_to = "name") %>%
